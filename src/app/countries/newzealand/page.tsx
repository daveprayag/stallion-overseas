    ...
    <div className="text-center flex flex-col items-center w-full min-h-screen pt-[100px] space-y-10 pb-[100px]">
      ...
      <div>
        ...
        <p className="text-justify xl:px-80 px-10 text-lg tracking-tight text-zinc-600 ">
          New Zealand is renowned for its stunning natural beauty, friendly
          locals, and world-class education system. With its pristine
          landscapes, outdoor adventures, and rich Maori culture, New Zealand
          offers students a truly unique and immersive experience. The
          country&apos;s universities and colleges are known for their high
          academic standards, innovative teaching methods, and supportive
          learning environment. Whether studying in the vibrant city of Auckland
          or the picturesque town of Dunedin, students are sure to find
          inspiration and opportunity at every turn.
        </p>
      </div>

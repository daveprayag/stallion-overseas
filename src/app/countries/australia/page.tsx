    ...
    <div className="text-center flex flex-col items-center w-full min-h-screen pt-[100px] space-y-10 pb-[100px]">
      ...
      <div>
        ...
        <p className="text-justify xl:px-80 px-10 text-lg tracking-tight text-zinc-600 ">
          Australia is a top choice for international students seeking
          high-quality education in a welcoming and diverse environment. With
          its world-renowned universities and colleges, cutting-edge research
          facilities, and innovative academic programs, Australia offers
          students the opportunity to excel in their chosen fields. The
          country&apos;s laid-back lifestyle, stunning landscapes, and vibrant
          cities make it an ideal destination for both study and exploration.
          From surfing on pristine beaches to discovering ancient rainforests,
          students can enjoy a rich and rewarding experience in this sun-soaked
          paradise.
        </p>
      </div>

...
export default function Page() {
    ...
    const fetchInstitutions = useCallback(async (countryName: string) => {
        try {
            const response =
                await InstitutionService.getInstance().getInstitutions(
                    countryName
                );
        ...
        <div className="text-center flex flex-col items-center w-full min-h-screen pt-[100px] space-y-10 pb-[100px]">
            ...
            <div>
                ...
                <p className="text-justify xl:px-80 px-10 text-lg tracking-tight text-zinc-600 ">
                    Dubai is emerging as a dynamic destination for international
                    students, combining academic excellence with vibrant city
                    life and groundbreaking innovation. Known for its
                    ultramodern campuses and highly ranked institutions, Dubai
                    offers diverse programs that align with global industry
                    demands, making it a fantastic launchpad for future careers.
                    The city&apos;s thriving multicultural environment ensures
                    students feel right at home, surrounded by peers from around
                    the world in a community that celebrates diversity. With
                    year-round sunshine, iconic architecture, and world-renowned
                    attractions like the Burj Khalifa and Palm Jumeirah, Dubai
                    is a place where students can build unforgettable memories
                    both inside and outside the classroom. From exploring
                    bustling souks to attending international festivals and
                    enjoying luxury shopping and dining, studying in Dubai
                    promises an experience filled with opportunities for growth,

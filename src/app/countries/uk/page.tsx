...
export default function Page() {
  ...
  return (
    <div className="text-center flex flex-col items-center w-full min-h-screen pt-[100px] space-y-10 pb-[100px]">
      {/* Info section */}
      <div>
        <h1 className=" text-zinc-800 font-semibold sm:text-4xl text-[22px] pt-6 pb-10 flex items-center justify-center gap-2 sm:gap-4">
        ...
        <p className="text-justify xl:px-80 px-10 text-lg tracking-tight text-zinc-600 ">
          The United Kingdom boasts a rich academic heritage, with its
          universities consistently ranked among the best in the world. From
          historic institutions like Oxford and Cambridge to modern campuses in
          bustling cities, the UK offers a diverse array of educational
          opportunities. Students benefit from a supportive and multicultural
          environment, where they can engage with peers from around the globe.
          With its vibrant cities, iconic landmarks, and rich cultural heritage,
          the UK provides a stimulating backdrop for academic and personal
          growth. From exploring London&apos;s world-class museums to hiking in
          the Scottish Highlands, students are sure to find inspiration at every
          turn.
        </p>
      </div>

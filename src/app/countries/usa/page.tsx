...
export default function Page() {
  ...
  return (
    <div className="text-center flex flex-col items-center w-full min-h-screen pt-[100px] space-y-10 pb-[100px]">
      {/* Info section */}
      <div>
        <h1 className=" text-zinc-800 font-semibold sm:text-4xl text-[20px] pt-6 pb-10 flex items-center justify-center gap-2 sm:gap-4">
        ...
        <p className="text-justify xl:px-80 px-10 text-lg tracking-tight text-zinc-600 ">
          The United States is synonymous with academic excellence, offering a
          wide range of programs and research opportunities at its prestigious
          universities and colleges. With campuses located in vibrant cities and
          picturesque towns, students can immerse themselves in diverse
          communities and cultures. The US is known for its welcoming
          atmosphere, where international students are embraced and encouraged
          to pursue their academic and personal goals. Beyond the classroom,
          students can explore the country&apos;s stunning natural landscapes,
          iconic landmarks, and dynamic cultural scene, making for an enriching
